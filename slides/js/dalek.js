var id;
var consoleStartDalek = function(){
    ...
    function init(){
        ...
        importer.import('newdalekparadigm.js', 100, [0,0,0], [0,0,0], function(geometry, object){
            scene.add( object );
        ...
        var console = document.getElementById('dalek');
...
var consoleClearDalek = function() {
    var console = document.getElementById('dalek');
    if (console.hasChildNodes())
